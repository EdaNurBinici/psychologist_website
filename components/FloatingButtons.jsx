...
export default function FloatingButtons() {
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Merhaba, randevu almak istiyorum. Lütfen uygun saatleri bilgilendiriniz.");
  ...
  return (
    <div className="floating-buttons">
      {showScrollTop && (
        ...
        >
          <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><polyline points="18 15 12 9 6 15"></polyline></svg>
        </button>
      )}
      <button 
      ...
      <a href="tel:+905555555555" className="floating-btn floating-btn-phone" title="Ara">
